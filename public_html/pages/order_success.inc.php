<?php
  ...
  document::$snippets['title'][] = language::translate('title_order_success_EC', 'Orden exitosa');

  breadcrumbs::add(language::translate('title_checkout', 'Checkout'), document::ilink('checkout'));
  breadcrumbs::add(language::translate('title_order_success_EC', 'Orden exitosa'));
