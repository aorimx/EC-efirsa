<?php
  ...
  document::$snippets['title'][] = language::translate('regional_settings:head_title_EC', 'Ajustes regionales');

  breadcrumbs::add(language::translate('title_regional_settings_EC', 'Ajustes regionales'));
