<?php
  ...
  if (empty(cart::$items)) {
    echo '<div class="empty-cart-content"><div class="left-content"></div><div class="middle-content"><div class="content"><img src="{snippet:template_path}images/e-commerce/Carro_Vacio.png"></div><div class="content"><p><em>'. language::translate('description_no_items_in_cart_EC', 'No hay objetos en tu carrito') .'</em></p></div>' . PHP_EOL
