    ...
    public function email_order_copy($email, $language_code='') {
      ...
      */
      ...
      <body style='background:#bedae6'>
        <div class='mj-container' style='background-color:#bedae6'>
          <!--[if mso | IE]>
                          ...
                          <tr>
                            <td style='word-wrap:break-word;font-size:0;padding:15px 30px;padding-top:10px;padding-bottom:10px;padding-right:25px;padding-left:25px' align='center'>
                              <table role='presentation' cellpadding='0' cellspacing='0' style='border-collapse:separate' align='center' border='0'>
                                <tbody>
                                  <tr>
                                    <td style='border:none;border-radius:0;color:#fff;cursor:auto;padding:10px 25px' align='center' valign='top' bgcolor='#8bb420'><a href='%store_url' style='background:#8bb420;font-family:Ubuntu,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:120%;text-transform:none;margin:0;text-decoration:none;color:inherit' target='_blank'><strong>%store_name</strong></a></td>
                                  </tr>
                                </tbody>
                              </table>
                            </td>
