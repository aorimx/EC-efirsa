        ...
        <tr class="item">
          ...
          <td class="td_pieces">
            <div style="display: flex; width: 100%;">
              ...
              <?php echo functions::form_draw_button('remove_cart_item', array($key, functions::draw_fonticon('fa-trash')), 'button', 'class="btn btn-danger" title="'. htmlspecialchars(language::translate('title_remove', 'Remove')) .'" formnovalidate style="margin-right: 0; width: 25%;"'); ?>
            </div>
          </td>
