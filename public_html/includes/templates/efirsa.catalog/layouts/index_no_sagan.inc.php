...
{snippet:head_tags}
  ...
  <link rel="stylesheet" href="{snippet:template_path}engine1/style.css">
...
<script src="{snippet:template_path}js/demo1.js"></script>
<script src="{snippet:template_path}js/classie.js"></script>
<script src="{snippet:template_path}js/respond.js"></script>
