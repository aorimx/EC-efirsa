...
<div class="gris-footer">
  <div class="container resp-none">
    <div class="col-sm-4 centrar-footer">
      <ul class="redes-footer">
        <li><a href="https://www.facebook.com/Efirsa/" target="_blank"><img src="{snippet:template_path}images/fb-footerg.png"></a></li>
        <li><a href="https://www.instagram.com/efirsamx/" target="_blank"><img src="{snippet:template_path}images/instagram.svg" style="width: 24px;" alt=""></a></li>
        <li><a href="https://www.youtube.com/channel/UCAS0CzSP8m0o95ENQwm95PQ" target="_blank"><img src="{snippet:template_path}images/yt-footerg.png"></a></li>
      </ul>
    </div>
    <div class=" col-sm-4 centrar-footer">
      <p class="copyright">
  ...
  <div class="container-footer-2">
    <div class="col-xs-4 centrar-footer">
      <ul class="redes-footer">
        <li><a href="https://www.facebook.com/Efirsa/" target="_blank"><img src="{snippet:template_path}images/fb-footerg.png"></a></li>
        <li><a href="https://www.instagram.com/efirsamx/" target="_blank"><img src="{snippet:template_path}images/instagram.svg" style="width: 17px;" alt=""></a></li>
        <li><a href="https://www.youtube.com/channel/UCAS0CzSP8m0o95ENQwm95PQ" target="_blank"><img src="{snippet:template_path}images/yt-footerg.png"></a></li>
      </ul>
    </div>
