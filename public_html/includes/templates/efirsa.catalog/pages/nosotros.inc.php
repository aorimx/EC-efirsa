<?php   document::$layout = 'default_no_sagan'; ?>
  ...
  <div class="container-fluid">
    <div class="row separador-transportando div-transportando">
      <h2><img src="{snippet:template_path}images/comillas-izquierda.png">&nbsp;SOLUCIONES DE ALTURA<img src="{snippet:template_path}images/comillas-derecha.png"></h2>
      ...
      <div class="div-diferencia2">
        <div class="col-xs-12 col-lg-10 col-lg-offset-1 lista-clientes">
          ...
          <div class="col-xs-12 col-sm-12 mapa">
            <img src="{snippet:template_path}images/nosotros/efirsaMap.png" class="imgMapa img-responsive" alt="">
            <img src="{snippet:template_path}images/nosotros/mapTitle.png" class="titleMap img-responsive" alt="">
