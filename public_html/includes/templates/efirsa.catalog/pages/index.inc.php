...
<div class="container">
  <div class="row seccion-productos">
    <div class="padding-home">
      ...
      <p class="texto-verde enlaces-verdes"><a target="_blank" class="texto-verde enlaces-verdes" href="archivos/catalogo.pdf">Descargar nuestro catálogo<img class="flecha-enlace" src="{snippet:template_path}images/flecha-verde.png"></a></p>
    </div>
    <!--<img class="img-full" src="{snippet:template_path}images/cintillo-catalogo.jpg">-->
  </div>
</div>
...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="ws_images"><ul>
      <li><a href="#"><img src="data1/{snippet:template_path}images/slider1x.png" alt="Slider" title="slider-1" id="wows1_0"/></a></li>
      <li><img src="data1/{snippet:template_path}images/slider2x.png" alt="slider-2" title="slider-2" id="wows1_1"/></li>
      <li><img src="data1/{snippet:template_path}images/slider3x.png" alt="slider-3" title="slider-3" id="wows1_2"/></li>
    </ul></div>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="item active">
          <img src="{snippet:template_path}images/slider-1.png" alt="Efirsa Web Slider" style="width:100%;">
        ...
        <div class="item">
          <img src="{snippet:template_path}images/slider-2.png" alt="Efirsa Web Slider" style="width:100%;">
          <!--<div class="carousel-caption">
            <h3>Chicago</h3>
